 ...
 * dentro de `src/pages/**/markup.html` y `src/layout/*.html`; nunca debe recibir
 * contenido de usuarios, parámetros de URL, APIs ni almacenamiento local.
 * Mantener este límite en un solo componente permite migrar páginas a JSX de
 * forma gradual sin repartir `dangerouslySetInnerHTML` por la aplicación.
 */
